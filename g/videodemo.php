...
<form action="" method="post">
				<label style="font-size: 40px; color: white; font-weight: bold; position: absolute; left: 5%; ">ENTER ID:</label>
				<input style="height:40px; position: absolute; left: 20%; border: black solid 2px; " type="text" name="id"/>
