...
if(isset($_POST['submit']))
{
    ...
    $password = $_POST['pass'];  
        ...
        $sql = "select *from doctorapp where fname = '$username' and email = '$password'";  
...
<body>  
    <div id = "frm">  
        <h1>Login</h1>  
        <form name="f1" action = "signin2.php" onsubmit = "return validation()" method = "POST">  
            <p>  
            ...
            <p>  
               <a href="reg.php"> <label class="link"> Regiter new user   </label>   </a>  
            </p>   
        </form>  
    </div>  
