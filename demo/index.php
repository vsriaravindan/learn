		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">S.l</th>
				...
				<th class="text-center" scope="col">Mem_Id.</th>
        	...
        	$get_data = "SELECT * FROM doctorapp order by 1 desc";
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><h2>K2Fitness Gym</h2></center>
	...
	<!--	<input type='text' class='form-control' name='docapp' placeholder='Date of Birth'> -->
		<?php
		...
		<input type='text' class='form-control' name='prof' placeholder='Enter Profession'>
		</div>
		</div>
		...
		<div class='form-row'>
		<div class='form-group col-md-6'>
		<label for='fathername'>Medical Record</label><br>
		<a href="MEDICAL RECORD.docx"><input type="button" name="download" class="btn btn-info btn-large" value="Download"></a>
		</div>
		<div class='form-group col-md-6'>
		<label for='mothername'>Upload Medical Record</label>
